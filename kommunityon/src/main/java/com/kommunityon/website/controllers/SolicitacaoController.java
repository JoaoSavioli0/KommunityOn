...
public class SolicitacaoController {
    ...
    public ResponseEntity<List<SolicitacaoDTO>> solicitacoesUsuario(@PathVariable Long id, @RequestBody List<Integer> tagId){
        List<SolicitacaoDTO> solicitacoesCarregadas = solicitacaoService.solicitacoesUsuario(id, tagId);
        return ResponseEntity.ok(solicitacoesCarregadas);
    }
